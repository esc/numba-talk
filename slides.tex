...
\institute{Senior Software Engineer - Open Source\\
\url{https://anaconda.com}}

\title{A Whirlwind Tour of Numba}
\definecolor{gray}{rgb}{0.10,0.10,0.10}
\date{Python Users Berlin - Thursday 19 Feb 2026}
...
\begin{frame}
    ...
    \hspace{1em}
    \tiny\url{https://github.com/esc/numba-talk}
    \begin{tabular}[t]{lr}
